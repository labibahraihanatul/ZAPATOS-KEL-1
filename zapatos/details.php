...
<div id="container">
	<div class="nav">	
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<textarea name="destination" placeholder="Destination" style="height:200px; width:350px;" required></textarea>
						<select name="size" required style="width:250px;">
						...
						<br />
						<input type="checkbox" required> I Agree the <a href="#terms" data-toggle="modal"> Terms and Condition</a> of Zapatos Inc.
					</center>
				</div>
			<div class="modal-footer">
				<center>
		...
		<div id="terms" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">Zapatos Inc. Terms and Condition</h3>
			</div>
				<div class="modal-body">
					<ul>
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Zapatos Inc. 2021</p>
		</div>
			
			<div id="foot">
				<h4>Links</h4>
					<ul>
						<a href="http://www.facebook.com/Zapatoskk1"><li>Facebook</li></a>
						<a href="http://www.twitter.com/Zapatoskk1"><li>Twitter</li></a>
						<a href="http://www.pinterest.com/Zapatoskk1"><li>Pinterest</li></a>
						<a href="http://www.tumblr.com/Zapatoskk1"><li>Tumblr</li></a>
					</ul>
			</div>
			...
			<div id="develop">
				<h4>Developed By:</h4>
					<ul>
						<a href="#"><li>Ade F</li><a>
						<a href="#"><li>Arban R</li><a>
						<a href="#"><li>Akbar W</li><a>
						<a href="#"><li>Irfan N</li><a>
						<a href="#"><li>Labibah R</li><a>
						<a href="#"><li>Mohammad V</li><a>
					</ul>
			</div>
	</div>
</body>
